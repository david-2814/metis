...
# convention (`metis_core.events.bus._BUS_SESSION_ID`) — these events aren't
...
def rotate_key(
    *,
    ...
    from metis_gateway.issue_key import _serialize_entry as _issue_entry_serializer  # noqa: F401
    from metis_gateway.issue_key import build_new_key_record
