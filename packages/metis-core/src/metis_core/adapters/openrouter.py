...
from metis_core.adapters.openai import (
...
from metis_core.adapters.retry import RetryPolicy, with_retry
...
from metis_core.pricing.table import ModelPricing
...
def _translate_status_error(exc: openai.APIStatusError, request_id: str) -> AdapterError:
    from metis_core.adapters.errors import error_for_class
