...
from metis_core.routing.profiles import STANDARD_TASK_PROFILES, standard_profile_for
...
def test_openrouter_anthropic_opus_gets_opus_tags():
    assert "deep-reasoning" in standard_profile_for("openrouter:anthropic/claude-opus-4.7")
    assert "deep-reasoning" in standard_profile_for("openrouter:anthropic/claude-3-opus-20240229")
...
def test_openrouter_anthropic_haiku_gets_haiku_tags():
    ...
    assert "summarization" in standard_profile_for("openrouter:anthropic/claude-haiku-4-5")
