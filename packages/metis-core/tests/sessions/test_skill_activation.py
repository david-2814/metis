...
from metis_core.skills.activation import WARN_CUMULATIVE_ACTIVATION_TOKENS
from metis_core.skills.store import load_skills
...
def test_registry_warn_threshold_logs_once(caplog):
    r = SkillActivationRegistry()
    with caplog.at_level("WARNING", logger="metis_core.skills.activation"):
