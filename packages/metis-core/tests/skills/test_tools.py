...
from metis_core.skills.store import SkillStore, load_skills
from metis_core.skills.tools import register_skill_tools
...
async def test_search_returns_matches(bus, workspace, skills, dispatcher, event_log):
...
async def test_load_unknown_skill_returns_error(bus, workspace, skills, dispatcher, event_log):
    result = await dispatcher.dispatch(
...
async def test_load_emits_skill_loaded_event(bus, workspace, skills, dispatcher, event_log):
