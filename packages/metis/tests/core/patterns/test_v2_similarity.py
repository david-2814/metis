...
from metis.core.patterns.similarity import blended_similarity, cosine_similarity
...
def test_blend_specific_intermediate_values() -> None:
    ...
    from metis.core.patterns.similarity import _structural_jaccard
...
def test_v2_cluster_tighter_than_v1_on_paraphrase_pair() -> None:
    ...
    from metis.core.patterns.similarity import weighted_jaccard
