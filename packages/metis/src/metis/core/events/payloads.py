...
from metis.core.events.envelope import Actor, Event, Sensitivity, new_event_id, sensitivity_rank
...
PAYLOAD_REGISTRY: dict[str, tuple[type[msgspec.Struct], Sensitivity]] = {
    ...
    # `metis.core.trace.retention.is_audit_event` carries `trace.swept`
