...
from metis.core.memory.store import MemoryStore
...
class SessionManager:
    ...
    def _emit_llm_call_completed(
        ...
        *,
        ...
        from metis.core.canonical.content import ThinkingBlock
    ...
    def _emit_memory_events_for_changes(
        ...
        *,
        ...
        for file_name, after in memory_after.items():
            ...
            from metis.core.memory.store import MemoryFile
            from metis.core.memory.store import MemoryStore as _MS
...
_ = RoutingDecision  # exported via metis.core.routing
