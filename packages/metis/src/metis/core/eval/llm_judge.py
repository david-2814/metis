...
from metis.core.eval.verdict import EvalVerdict, clamp_unit
from metis.core.extensions import JudgeRubricProvider, NoopJudgeRubricProvider
...
class LLMJudge:
    ...
    def __init__(
        ...
        *,
        ...
        # `metis.core.extensions.JudgeRubricProvider`. OSS noop returns None
