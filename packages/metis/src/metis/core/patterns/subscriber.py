...
from metis.core.patterns.embeddings import EmbeddingProvider
from metis.core.patterns.fingerprint import (
    Fingerprint,
    FingerprintInputs,
    compute_fingerprint,
)
from metis.core.patterns.store import PatternStore, RecordResult
...
class PatternEventSubscriber:
    ...
    def __init__(
        ...
        *,
        ...
        # fingerprint_inputs_hook (apps/cli/src/metis.cli/runtime.py and
