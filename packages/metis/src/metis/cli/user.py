...
forget half delegates to `metis.core.redaction.forget.forget_user` —
...
from metis.core.analytics import AnalyticsStore, InvalidTimeWindowError, resolve_window
from metis.core.redaction.forget import forget_user as _forget_user
...
def run_user_forget_command(
    *,
    ...
    `metis.core.redaction.forget.forget_user`; this handler is a thin
    presentation shim.
