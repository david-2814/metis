...
from metis.core.adapters.errors import AdapterError, CancelledError
from metis.core.adapters.protocol import (
    CanonicalRequest,
    CanonicalResponse,
    StopReason,
)
from metis.core.adapters.streaming import MessageComplete, StreamingEvent
...
from metis.core.routing import ModelRegistry, RoutingEngine, TurnContext
...
class GatewayHarness:
    ...
    def _build_turn_context(
        ...
        *,
        ...
        from metis.core.canonical.content import ImageBlock, TextBlock, ToolUseBlock
    ...
    def _emit_llm_call_completed(
        ...
        *,
        ...
        from metis.core.canonical.content import ThinkingBlock, ToolUseBlock
