...
Lives alongside the existing extension surface in ``metis.core.extensions``.
...
from metis.gateway.auth import GatewayKey
from metis.gateway.quotas import TierCaps
