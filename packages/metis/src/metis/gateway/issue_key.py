...
from metis.core.events.payloads import GatewayKeyIssued, make_event
from metis.gateway.auth import (
...
def _emit_issued_event(*, record: dict[str, Any], db_path: Path) -> None:
    ...
    """
    from metis.gateway.keystore_admin import _ADMIN_SESSION_ID, _emit_audit_event
