"""Entry point used by `metis gateway` (mounted in metis.cli.main).
...
from metis.gateway.app import (
    DEFAULT_MAX_CONCURRENT_CONNECTIONS,
    GatewayConfig,
    GatewayConfigError,
    run_gateway,
)
from metis.gateway.runtime import (
    GatewaySetupError,
...
async def run_gateway_command(
    *,
    ...
    Returns a Unix-style exit code so `metis.cli.main` can propagate it.
