...
from metis.core.events.payloads import GatewayAuthFailed, make_event
...
from metis.gateway.auth import extract_bearer_token, identity_from_key
from metis.gateway.endpoints.anthropic import (
...
from metis.gateway.extensions import NoopTierCapsResolver, TierCapsResolver
...
from metis.gateway.middleware_ratelimit import RateLimitConfig, RateLimitMiddleware
from metis.gateway.middleware_versioning import VersioningMiddleware
from metis.gateway.quotas import (
    QuotaExceeded,
    RequestQuotaCache,
    enforce_quotas,
)
from metis.gateway.runtime import GatewayRuntime
from metis.gateway.translators import (
...
class GatewayConfig:
    ...
    # See packages/metis-core/src/metis.core/extensions.py.
    #
    ...
    # apps/gateway/src/metis.gateway/extensions.py for the contract.
...
def build_app(
    ...
    *,
    ...
    (metis.core.extensions). §4.3 (2026-05-18) moved the implementation
