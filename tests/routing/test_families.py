...
from metis.routing.families import (
    family_key,
    filter_by_pattern,
    select_primary,
    version_key,
...
def test_openrouter_strips_semver_version():
    assert (
        family_key("openrouter:anthropic/claude-opus-4.7")
        == "openrouter:anthropic/claude-opus"
    )
    assert (
        family_key("openrouter:anthropic/claude-opus-4")
        == "openrouter:anthropic/claude-opus"
    )
    assert (
        family_key("openrouter:openai/gpt-5-1.2.3")
...
def test_openrouter_strips_iso_date():
    assert (
        family_key("openrouter:openai/gpt-4-turbo-2024-04-09")
