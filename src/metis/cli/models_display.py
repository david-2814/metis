...
Filtering uses :mod:`metis.routing.families` to collapse OpenRouter versions
...
from metis.routing.families import filter_by_pattern, select_primary
    ...
    for key in sorted(tree.keys()):
        ...
        if isinstance(val, dict):
            ...
            if not any_profile:
                ...
                lines.append(
                    f"{prefix}{prefix_pad}  {price}{price_pad}{profile_segment}"
                )
